...
<head id="Head1">
    ...
    <script type="text/javascript">
        function changeOrgCode() {
            document.getElementById("orgCode").style.display = "block";
            document.getElementById("orgCodeTitle").style.display = "none";
        ...
        function checkLogin() {
            ...
            if (isOk == true) {
                var returnMsg = yk.post("ajax/login.ashx", "orgCode=" + orgCode + "&userName=" + userName + "&userPwd=" + userPwd + "&verCode=" + verCode, null);
                if (returnMsg == "1") {
...
<body>
    <div class="loginDiv" id="loginDiv">
        ...
        <table>
            <tr>
                <td colspan="2">
                    <input type="text" id="orgCodeTitle" value=" 请输入租户编码" onfocus="changeOrgCode()" />
                    <input type="text" id="orgCode" title="租户编码"  style="display:none;" onblur="changeOrgCodeCheck()" />
                </td>                
            </tr>
            <tr>
                <td colspan="2">
