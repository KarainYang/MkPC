<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganizationList.aspx.cs" Inherits="Admin_AdminModel_Organization_OrganizationList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
        //添加
	    function add() {
	        showLayer('添加', 'OrganizationView.aspx', 500, 300);
	    }
	    
	    //修改
	    function update(id) {
	        showLayer('编辑', 'OrganizationView.aspx?id=' + id, 500, 300);
	    }
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td > <%# Eval("Name")%></td>
                                <td> <%# Eval("Code") %></td>               
                                <td> <%# Convert.ToDateTime(Eval("CreatedOn").ToString()).ToString("yyyy-MM-dd") %></td>
                                <td>
