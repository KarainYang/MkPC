<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdverCategoryList.aspx.cs" Inherits="Admin_AdminModel_System_AdverCategoryList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'AdverCategoryView.aspx', 550, 260);
	    }
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'AdverCategoryView.aspx?id=' + id, 550, 260);
	    }
