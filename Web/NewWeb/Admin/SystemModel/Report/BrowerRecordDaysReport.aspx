<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BrowerRecordDaysReport.aspx.cs" Inherits="Admin_SystemModel_Report_BrowerRecordReport" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div  class="navigation">   
               ...
               <a href="BrowerRecordYearReport.aspx">年度图形报表</a>
            </div>
            ...
            <yk:ReportChart runat="server" id="ReportChart1"  title="日访问量"></yk:ReportChart>
    </form>
</body>
</html>
