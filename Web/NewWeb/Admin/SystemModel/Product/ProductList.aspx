                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td class="TdAmount"> <%# Eval("PurchasPrice")%></td> 
                                <td class="TdAmount"> <%# Eval("MarketPrice")%></td> 
                                <td class="TdAmount"> <%# Eval("SalesPrice")%></td> 
                                <td class="TdSerial"> <%# Eval("OrderBy")%></td>  
                                <td> <%# Eval("Mark").ToStr().Contains("1")?"折扣专区":"" %> <%# Eval("Mark").ToStr().Contains("2") ? "首页推荐商品" : ""%> <%# Eval("Mark").ToStr().Contains("3") ? "特价专区" : ""%></td>
                                <td> <%# Eval("Creater")%></td>               
                                <td class="TdDate" format="yyyy-MM-dd "> <%# Convert.ToDateTime(Eval("AddDate").ToString()).ToString("yyyy-MM-dd") %></td>
                                <td>                                 
