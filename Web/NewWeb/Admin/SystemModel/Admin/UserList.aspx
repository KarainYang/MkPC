<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="Admin_AdminModel_User_UserList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
        //添加
	    function add() {
	        showLayer('添加','UserView.aspx', 500, 300);
	    }
	    
	    //修改
	    function update(id) {
	        showLayer('编辑','UserView.aspx?id=' + id, 500, 300);
	    }
	    
	    //角色设置
	    function roleSet(id) {
	        showLayer('角色设置','UserInRole.aspx?id=' + id, 500, 360);
	    }
    ...
    <form id="form1" runat="server">
           <div  class="navigation">               
            ...
            <div  class="topOpration">                               
                <input type="button" class="buttonCss" id="addBtn" value="添加" onclick="add()" IsEnter="true"></input>
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:roleSet(<%# Eval("ID") %>)"><img src="<%=CommonClass.AppPath %>Admin/images/edit.gif" title="编辑" class="edit"/></a>
                                </td>
                            </tr>
                    </ItemTemplate>
                    <FooterTemplate>
