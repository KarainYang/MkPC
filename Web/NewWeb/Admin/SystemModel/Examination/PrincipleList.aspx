<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrincipleList.aspx.cs" Inherits="Admin_SystemModel_Exam_PrincipleList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'PrincipleView.aspx', 800, 600);
	    }

	    //编辑
	    function update(id)
	    {
	        showLayer('编辑', 'PrincipleView.aspx?id=' + id, 800, 600);
	    }
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr ondblclick="update(<%# Eval("ID") %>)">
                                ...
                                <td> <%# DataToCacheHelper.GetAllDictionaries().Where(w=>w.Code==Eval("Module").ToStr() && w.TypeCode=="03").First().Name %></td>   
                                <td> <%# Eval("Creater")%></td>               
