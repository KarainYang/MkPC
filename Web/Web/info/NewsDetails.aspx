<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsDetails.aspx.cs" Inherits="info_NewsDetails" %>
...
<div class="Contain">
    ...
    <div class="Maincontent">
      ...
      <!--Content Start-->
          <div style="line-height:30px; font-weight:bold; font-size:20px;"><%= news.Title%></font></h2></div>
          <div class="safe">
              <%= news.Remark%>  
        </div>
      <!--信息提示End-->      
