    ...
    <center>
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="740" border="0">
                            ...
                            <tr style="display:none;">
                                ...
                                <td class="form-right" align="left"><input size="30" name="aliorder" maxlength="200" runat="server" id="aliorder" value="支付宝测试"><span>如：7月5日定货款。</span></td>
                            </tr>
                            <tr style="display:none;">
                                <td class="form-left">
                                    付款金额：
        ...
        <form id="Form1" runat="server">
           <div style=" width:800px; margin:auto;color:Gray; text-align:left; line-height:20px;">
                       <span style="margin:10px; color:red; font-weight:bold;">订单详细信息</span>
                        <asp:Repeater runat="server" ID="RepOrderInfo">
                            <ItemTemplate>
                                <table class="ordertable" width="100%" border="1" cellpadding="0" cellspacing="0">
                                   <tr>
                                        <td class="order_title" style="width:100px;" align="right">订单号：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("OrderNumber") %>
                                        </td>                   
                                        <td class="order_title" style="width:100px;" align="right">订单日期：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("OrderDate") %>
                                        </td>
                                   </tr>
                                   <tr>
                                        <td class="order_title" align="right">订单数量：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("ProCount") %>
                                        </td>                 
                                         <td class="order_title" align="right"> 订单总价：</td>
                                        <td class="order_title">
                                            &nbsp;￥ <%# Eval("MoneySum") %>
                                        </td>
                                   </tr>
                                   <tr>
                                       <%--  <td class="order_title" align="right">用户名：</td>
                                        <td class="order_title">
                                           &nbsp;<%# Eval("UserName") %>
                                        </td>--%>
                                         <td class="order_title" align="right">付款方式：</td>
                                        <td class="order_title" colspan="3">
                                            &nbsp;<%# Eval("PaymentTitle") %>
                                        </td>
                                    </tr>
                                   <tr>
                                          <td class="order_title" align="right">送货方式：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("ConsigumentTitle") %>
                                        </td>
                                         <td class="order_title"  align="right">订单状态：</td>
                                         <td class="order_title">
                                            &nbsp;<%# Eval("OrderStateTitle") %>
                                         </td>                    
                                   </tr>
                                    <tr>
                                         <td class="order_title" align="right">联系人：</td>
                                        <td class="order_title">
                                           &nbsp;<%# Eval("BuyerName") %>
                                        </td>
                                         <td class="order_title" align="right">公司名称：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("CompanyName") %>
                                        </td>
                                   </tr>
                                   <tr>
                                          <td class="order_title" align="right">地址：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("Address") %>
                                        </td>
                                         <td class="order_title"  align="right">邮编：</td>
                                         <td class="order_title">
                                            &nbsp;<%# Eval("PostalCode") %>
                                         </td>                    
                                   </tr>
                                    <tr>
                                         <td class="order_title" align="right">电话：</td>
                                         <td class="order_title">
                                            &nbsp;<%# Eval("Phone") %>
                                         </td>
                                   ...
                                   <tr>
                                         <td class="order_title" align="right">手机号：</td>
                                         <td class="order_title">
                                            &nbsp;<%# Eval("Mobile") %>
                                         </td>                  
                                        <td class="order_title" align="right">邮箱：</td>
                                        <td class="order_title">
                                            &nbsp;<%# Eval("Email") %>
                                        </td>
                                     </tr>
                                     <tr>                     
                                        <td class="order_title" align="right">客户留言：</td>
                                        <td class="order_title" colspan="3">
                                            &nbsp;<%# Eval("BuyerNote") %>
                                        </td>
                                     </tr>
                        ...
                        <span style="margin:10px; color:red;font-weight:bold;">订单详细列表</span>
