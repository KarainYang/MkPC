...
namespace AlipayClass
{
    ...
    public class AlipayConfig
    {
        ...
        public AlipayConfig()
        {
            ...
            partner = "2088602235246741";

            //交易安全检验码，由数字和字母组成的32位字符串
            key = "829lpy75g49stddq41wga4cbjy5dd186";

            //签约支付宝账号或卖家支付宝帐户
            seller_email = "13829725842";// "13631459804";

            //付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            //return_url的域名不能写成http://localhost/js_vs2005_gb/return_url.aspx ，否则会导致return_url执行无效
            return_url = "http://shopping.51mke.com/Alipay/return_url.aspx";

            //交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://shopping.51mke.com/Alipay/notify_url.aspx";

            //网站商品的展示地址，不允许加?id=123这类自定义参数
            show_url = "http://shopping.51mke.com/product/products.aspx";
