<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Orders.aspx.cs" Inherits="member_Orders" %>
              ...
              <asp:Repeater runat="server" ID="RepList" onitemdatabound="RepList_ItemDataBound">
                    <ItemTemplate> 
                      <tr>
                        ...
                        <td class="pro">
                            ...
                            <ul>
                                <asp:Repeater runat="server" ID="RepDetails">
                                    <ItemTemplate>
                                        <li><a href="../product/product.aspx?id=<%# Eval("ProductID") %>" target="_blank" title="<%# Eval("ProName") %>"><img src="<%# CommonClass.AppPath+ Eval("ProductID").GetEntity<TB_Product_Products>().ImgUrl %>" /></a></li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
                        </td>
                        ...
                        <td>
                        <dt class="operate">
                        <a href="OrderDetails.aspx?OrderNumber=<%# Eval("OrderNumber") %>">查看详细</a>
                        <a href="mylogistics.shtml">查看物流</a>
                        <a href="ReturnGood.aspx?OrderNumber=<%# Eval("OrderNumber") %>">退换货</a>
                        </dt>
                        </td>
                      </tr>
                </ItemTemplate>
