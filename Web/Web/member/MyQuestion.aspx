<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyQuestion.aspx.cs" Inherits="member_MyQuestion" %>
...
<div class="Contain">
    ...
    <div class="Maincontent">  
      ...
      <h3 class="Title">咨询信息</h3>
      
      <div class="Main">
      <!--Content Start-->
        
        <div class="myquestion_form">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable">
                  ...
                  <%
                      foreach (YK.Model.TB_Product_Questions entity in list)
                      {
                          YK.Model.TB_Product_Products product = YK.Service.ProductService.ProductsService.Get(entity.ProductID);
                       %>  
                      <tr>
                        <td>
                            <a href="<%= YK.Common.CommonClass.AppPath+"product/product.aspx?id="+entity.ProductID %>#question" target="_blank" title="点击查看该商品提问">
                                <%=product.ProName %>
                            </a>
                        </td>
