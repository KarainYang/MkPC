...
<body>
    ...
    <div> 
        ...
        <%
            int i = 0;
            string[] arr = { "#53AECF", "Red", "blue", "#73CED6", "green", "#97009F", "#2D89F0", "#DA542E" };
            foreach (YK.Model.TB_Admin_Resources resource in resources)
            {
                if (i == arr.Length)
                {
                    i = 0;
                ...
                %>
            <a href="menu.aspx?rid=<%=resource.ID %>" target="menu" style=" cursor:pointer;">
                <div class="menuDiv" style=" background-color:<%=arr[i]%>;"><%= resource.ResourceName %></div>
            </a>
        <%
                i++;
            }
