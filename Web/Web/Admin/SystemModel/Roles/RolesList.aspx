<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RolesList.aspx.cs" Inherits="Admin_AdminModel_Roles_RolesList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加','RolesView.aspx',450,200);
	    }
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑','RolesView.aspx?id='+id,450,200);
	    }

	    //权限管理
	    function resourcesSet(id) {
	        showLayer('编辑', 'RoleInResource.aspx?id=' + id, 800, 500);
	    }
	</script>
</head>
<body>
    <form id="form1" runat="server">
            <div  class="navigation" onclick="">               
               <a href="RolesList.aspx">角色管理</a> > 角色列表
            </div>
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td align="left"> <%# Eval("RoleName")%></td>
                                <td> <%# Eval("Creater") %></td>               
                                ...
                                <td>
                                    <a href="javascript:resourcesSet(<%# Eval("ID") %>)">权限管理</a>
                                </td>
                            </tr>
                    </ItemTemplate>
                    <FooterTemplate>
