<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CouponList.aspx.cs" Inherits="Admin_AdminModel_Member_CouponList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加','CouponView.aspx',500,220);
	    }
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'CouponView.aspx?id=' + id, 500, 220);
	    }
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="CouponNosList.aspx?couponID=<%# Eval("ID") %>">发放优惠券</a>
                                </td>
                            </tr>
                    </ItemTemplate>
                    <FooterTemplate>
