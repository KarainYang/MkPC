<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Categorys.aspx.cs" Inherits="Admin_SystemModel_Product_Categorys" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%
                            ...
                            {
                             %>
                        <a href="Categorys.aspx?cid=<%# Eval("ID") %>&num=<%=num %>">下级类别</a>
                        <%
                            }
                                 %>
                        <% 
                        ...
                        <%
                            ...
                            {
                             %>
                        <a href='javascript:CategoryAdverSet(<%# Eval("ID") %>)'>广告设置 </a>
                        <%
                            }
                             %>
                        <%# 
