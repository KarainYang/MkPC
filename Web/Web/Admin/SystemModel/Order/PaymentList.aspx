<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentList.aspx.cs" Inherits="Admin_SystemModel_Order_PaymentList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'PaymentView.aspx', 500, 250);
	    }

	    //编辑
	    function update(id)
	    {
	        showLayer('编辑', 'PaymentView.aspx?id=' + id, 500, 250);
	    }
	</script>
</head>
<body>
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td align="left"> <%# Eval("PaymentTitle")%></td>   
                                <td> <%# Eval("OrderBy")%></td>  
