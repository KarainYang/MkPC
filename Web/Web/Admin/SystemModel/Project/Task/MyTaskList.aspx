<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyTaskList.aspx.cs" Inherits="Admin_SystemModel_Project_TaskMyList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    //处理
	    function handle(id) {
	        showLayer('处理', 'TaskHandle.aspx?id=' + id, 600, 300);
	    }
	    //详细
	    function details(id) {
                ...
                <asp:Repeater ID="RepList" runat="server">
                    ...
                    <ItemTemplate>
                            <tr>
                                ...
                                <td>                                 
                                    <a href="javascript:handle(<%# Eval("ID") %>)">处理</a>
