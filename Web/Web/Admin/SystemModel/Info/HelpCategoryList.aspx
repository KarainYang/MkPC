<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpCategoryList.aspx.cs" Inherits="Admin_SystemModel_Info_HelpCategoryList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'HelpCategoryView.aspx', 450, 200);
	    }
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'HelpCategoryView.aspx?id=' + id, 450, 200);
	    }	    
	</script>
</head>
<body>
    <form id="form1" runat="server">
           <div  class="navigation">               
               <a href="HelpCategoryList.aspx">帮助中心类别管理</a> > 帮助中心类别列表
            </div>
