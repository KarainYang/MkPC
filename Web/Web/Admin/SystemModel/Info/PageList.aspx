<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageList.aspx.cs" Inherits="Admin_SystemModel_Info_PageList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'PageView.aspx', 900, 530);
	    }
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'PageView.aspx?id=' + id, 900, 530);
	    }	    
	</script>
</head>
<body>
    <form id="form1" runat="server">
           <div  class="navigation">               
                <a href="PageList.aspx">单篇页管理</a> > 单篇页列表
            </div>
