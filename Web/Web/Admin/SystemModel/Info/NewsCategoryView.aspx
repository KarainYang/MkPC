<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsCategoryView.aspx.cs"
    Inherits="Admin_SystemModel_Info_NewsCategoryView" %>
    ...
    <table class="fromTable">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请输入标识！" ControlToValidate="TbCode"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <th>
