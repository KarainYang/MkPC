<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinksList.aspx.cs" Inherits="Admin_SystemModel_Info_LinksList" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'LinksView.aspx', 600, 200);            
        }            
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'LinksView.aspx?id=' + id, 600, 200);
	    }
	</script>
</head>
<body>
    <form id="form1" runat="server">
           <div  class="navigation">               
                <a href="LinksList.aspx">友情连接管理</a> > 友情连接列表
            </div>
