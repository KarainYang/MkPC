<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotSearch.aspx.cs" Inherits="Admin_SystemModel_Info_HotSearch" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function add()
	    {
	        showLayer('添加', 'HotSearchView.aspx', 380, 200);            
        }            
	    
	    //修改
	    function update(id)
	    {
	        showLayer('编辑', 'HotSearchView.aspx?id=' + id, 380, 200);
	    }
	</script>
</head>
<body>
    <form id="form1" runat="server">
           <div  class="navigation">               
                <a href="LinksList.aspx">热门搜索管理</a> > 热门搜索
            </div>
