<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupBuy.aspx.cs" Inherits="promotion_GroupBuy" %>
...
<div class="Wrap_GroupBuyList">
    <h2 class="GroupBuy_tab">
        <span class="show">
            ...
            <a id="GroupBuyListNew1_lbShowTypePast" href="PassGroupBuy.aspx">往期团购</a>
        </span>
    </h2>
        ...
        <div>
            <!--今日团购 start-->
                <ul class="GroupBuy_List">   
                    ...
                    <li>
                        <div class="Group_img">
                            <a href="GroupBuyDetails.aspx?id=<%=entity.ID %>">
                        ...
                        <h3> 
                            ...
                            <a class="Buynow_btn" href="GroupBuyDetails.aspx?id=<%=entity.ID %>" style="display: block;"></a>                            
                        </h3>
                        <h4>
                            <span id="spanRemainder6928159"></span>
                            已卖出<b><%=GetProSum(entity.ID)%></b>件
                            <span><font>原价：<s>￥<%=entity.Price %></s></font> <font>节省：<em>￥<%=entity.Price-entity.GroupPrice %></em></font></span>
                        </h4>                                
                    </li>  
                    <%
                        }
