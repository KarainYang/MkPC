...
namespace YK.Core
{
    ...
    public class Pager
    {
        ...
        /// <returns></returns>
        public IDataReader GetPagerInfo(string TableName, string PrimaryKey, string selectValue, int PageSize, int PageIndex, string Where, string OrderBy, ref int recordCount, List<SqlParameter> spr)
        {
            ...
            recordCount = new SqlHelper().ExecuteScalar(cmdText, spr).ToInt();
            ...
            return new SqlConvertHelper().ExecuteReader(cmdText, spr);
        }
        ...
        /// <param name="spr"></param>
        /// <returns></returns>
        public IDataReader GetPagerInfo(string TableName, string PrimaryKey, int PageSize, int PageIndex, string Where, string OrderBy, ref int recordCount, List<SqlParameter> spr)
        {
        ...
        /// <param name="recordCount"></param>
        /// <returns></returns>
        public IDataReader GetPagerInfo(string TableName, string PrimaryKey, string selectValue, int PageSize, int PageIndex, string Where, string OrderBy, ref int recordCount)
        {
        ...
        /// <param name="recordCount"></param>
        /// <returns></returns>
        public IDataReader GetPagerInfo(string TableName, string PrimaryKey, int PageSize, int PageIndex, string Where, string OrderBy, ref int recordCount)
        {
