...
namespace YK.Core
{
    ...
    public class SqlHelper
    {
       ...
       public  SqlConnection GetConnection()
       {
           ...
           {
               return new SqlConnection(new ConnectionHelper().GetConnectionString());
           }
       }
       ...
       public DataSet GetDataSet(string cmdText)
       {
        ...
        /// <param name="spr"></param>
        /// <returns></returns>
       public SqlDataReader ExecuteReader(CommandType cmdType, string cmdText, List<SqlParameter> spr)
       {
        ...
        /// <param name="spr"></param>
        /// <returns></returns>
       public SqlDataReader ExecuteReaderPro(string cmdText, List<SqlParameter> spr)
       {
        ...
        /// <param name="cmdText"></param>
        /// <returns></returns>
       public SqlDataReader ExecuteReaderPro(string cmdText)
       {
        ...
        /// <param name="spr"></param>
        /// <returns></returns>
       public SqlDataReader ExecuteReader(string cmdText, List<SqlParameter> spr)
       {
