...
namespace YK.Core
{
    ...
    public class EntityConverter
    {
       ...
       {      
           ...
           {typeof(Guid),typeof(Extension).GetMethod("ToGuid",new Type[]{typeof(object)})},
           {typeof(Guid?),typeof(Extension).GetMethod("ToNullable",new Type[]{typeof(object)})},
           {typeof(DateTime?),typeof(Extension).GetMethod("ToNullable",new Type[]{typeof(object)})}
