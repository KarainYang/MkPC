...
namespace YK.Common.Excel
{
    ...
    public class ExcelHelper
    {
        ...
        public XSSFWorkbook Import(Stream input)
        {
        ...
        /// <returns>集合</returns>
        private Dictionary<int, List<string>> Import(string filePath)
        {
            // 把excel文件实例化为NOPI实例
            IWorkbook workbook;
        ...
        public XSSFWorkbook CreateExcel(IEnumerable data)
        {
            return CreateExcel(data, this.TemplateFileName);
        }

        public XSSFWorkbook CreateExcel(IEnumerable data, string[] headers)
        {
        ...
        public XSSFWorkbook CreateExcel(IEnumerable data, string templateFileName)
        {
